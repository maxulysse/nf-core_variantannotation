# nf-core/variantannotation: Usage
...
```bash
nextflow run nf-core/variantannotation --input ./samplesheet.csv --outdir ./results --genome GRCh37 -profile docker
```
...
```bash
nextflow run nf-core/variantannotation -profile docker -params-file params.yaml
```
...
```bash
nextflow pull nf-core/variantannotation
```
